...
public class RouteRepository extends BaseRepository {
    ...
    public List<Route> getRoutesForMichal() {
        ...
        routes.add(route);
        route = new Route(4, 3.1, 130, "icons8_more", "icons8_more", "Sprinterska", "Nie masz zbyt wiele czasu, bo w brzuszku już burczy? Trasa w sam raz dla Ciebie! Oferuje krótki spacer po najciekawszych okazach w Arboretum, kończąc Twoją przygodę w naszej restauracji ;)");
        routes.add(route);
        route = new Route(5, 8.9, 530, "icons8_map", "icons8_map", "W poszukiwaniu ciekawych roślinek", "Za pomocą naszej super funkcjonalności, jaką jest QR kod, już nie będziesz musiał chodzić po Arboretum z Atlasem roślin! (jakbyś kiedykolwiek w ogóle wpadł na pomysł, że można tak robić) Sciągnij naszą super aplikację już dziś! (oł jeee).");
        routes.add(route);
        route = new Route(6, 13., 540, "icons8_heart", "icons8_heart", "Całodzienna trasa dla cieszących się życiem", "To jest trasa dla prawdziwych kozaków! " + System.getProperty("line.separator") + "(zastanawiam się czy zrobił się enter normalnie - bo to taki kozacki enter, prawie tak kozacki jak ta trasa :D). ");
        routes.add(route);
